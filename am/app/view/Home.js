				...
				'AM.view.Home',
				{
										...
										'Ext.dataview.DataView',
										{
											store : {
												...
												data : [
														{
															name : 'Dashboard',
															imageUrl : './resources/images/dashboard/dashboard_icon.jpg'
														},
														{
															name : 'Analysis',
															imageUrl : './resources/images/dashboard/analysis_icon.jpg'
														},
														{
															name : 'Setup',
															imageUrl : './resources/images/dashboard/setting_icon.png'
														},
														{
															name : 'Admin',
															imageUrl : './resources/images/dashboard/setting_icon.png'
														...
														{
															name : 'LogOff',
															imageUrl : './resources/images/dashboard/logoff_icon.gif'
														} ]
											},
					...
					handleClickEvent : function(grid, index, target, record, e,
						...
						if (record.data.name == 'Dashboard') {
							...
							Ext.Msg.alert('Info','Please use web console to setup new configuration');
						}
						else if( record.data.name == 'Admin'){
							if( this.adminPanel == undefined){
								this.adminPanel = Ext.create('AM.view.admin.Main');
